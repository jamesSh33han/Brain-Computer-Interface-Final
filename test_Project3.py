...
eeg_epochs, epoch_times, target_events, all_trials, event_stimulus_ids = Project3.get_eeg_epochs(fif_file, filtered_data, start_time, end_time, fs)
...
is_trial_greater_than_170bpm=Project3.get_truth_labels(tempo_labels)
